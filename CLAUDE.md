...
haneng is a **cross-platform Korean/English IME state indicator**: hover the mouse over a text input and a badge appears next to the cursor showing the current mode — blue **한** (Korean) / gray **a** (English lowercase) / orange **A** (English + Caps Lock). Windows, macOS, and Linux (X11). That is the whole product as of v0.4.0.
